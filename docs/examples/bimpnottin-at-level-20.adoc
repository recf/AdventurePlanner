...
| icon:check-square-o[] | 7 | Intelligence 
| icon:check-square-o[] | 8 | Wisdom 
...
| Scimitar | Melee Attack | 9 | d6+3/slashing 
| Scimitar | Melee Attack (Bonus Action) | 9 | d6/slashing 
| Darts | Ranged Attack | 7 | d4+1/piercing 
|===
