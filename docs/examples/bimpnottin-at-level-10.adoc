...
| icon:check-square-o[] | 5 | Intelligence 
| icon:check-square-o[] | 6 | Wisdom 
...
| Scimitar | Melee Attack | 7 | d6+3/slashing 
| Scimitar | Melee Attack (Bonus Action) | 7 | d6/slashing 
| Darts | Ranged Attack | 5 | d4+1/piercing 
|===
