...
** link:./AdventurePlanner.UI/ViewModels/CharacterPlanViewModel.cs#L50[50] Consider: Instead of calling AddLevel on create, instead call SetFromPlan() with initial state.
